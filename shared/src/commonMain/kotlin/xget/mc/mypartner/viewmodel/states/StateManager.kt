...
import xget.mc.mypartner.viewmodel.URI
...
class StateManager(repo: GptRepository) {
    ...
    val debugLogger = DebugLogger("StateManager")
...
data class AppState (
    ...
    fun getNavigation(model: MyParterViewModel) : Navigation {
