...
import xget.mc.mypartner.viewmodel.screens.navigationSettings
import xget.mc.mypartner.viewmodel.states.StateManager
import xget.mc.mypartner.viewmodel.states.StateProvider
...
class Navigation(val stateManager : StateManager) {
    ...
    private fun isInAnyVerticalNavigationLevel(screenIdentifier: ScreenIdentifier) : Boolean {
